      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px' }}>
        ...
        <div className="card">
          <div className="card-header">
            ...
            <a href="/calls" style={{ color: 'var(--primary)', textDecoration: 'none', fontWeight: 500 }}>
              Visa alla →
            </a>
          </div>
        ...
        <div className="card">
          <div className="card-header">
            ...
            <a href="/bookings" style={{ color: 'var(--primary)', textDecoration: 'none', fontWeight: 500 }}>
              Visa alla →
            </a>
          </div>
          ...
          <div style={{ marginTop: '24px', padding: '16px', background: 'linear-gradient(135deg, #6366f1 0%, #ec4899 100%)', borderRadius: 'var(--radius-sm)', color: 'white' }}>
            <div style={{ fontWeight: 600 }}>AI-analys</div>
            <div style={{ fontSize: '14px', opacity: 0.9 }}>Vanligaste ärendet idag: VVS-problem (45%)</div>
          </div>
        </div>
      </div>
    </div>
